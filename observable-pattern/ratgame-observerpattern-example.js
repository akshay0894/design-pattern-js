...
console.log("after rat2 enters", rat1.attack);
console.log("after rat2 enters", rat2.attack);

let rat3 = new Rat(game);
console.log("after rat3 enters", rat1.attack);

rat3.die();
console.log("after rat3 dies", rat1.attack);
